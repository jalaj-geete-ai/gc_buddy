...
{de:"Hier ist Ihr Wasser.",en:"Here is your water."},
{de:"Ist Ihnen kalt?",en:"Are you cold?"},
{de:"Ist Ihnen zu warm?",en:"Are you too warm?"},
{de:"Brauchen Sie eine Decke?",en:"Do you need a blanket?"},
{de:"Setzen Sie sich bitte.",en:"Please sit down."},
{de:"Stehen Sie bitte langsam auf.",en:"Please stand up slowly."},
{de:"Warten Sie bitte einen Moment.",en:"Please wait a moment."},
{de:"Ich komme in fünf Minuten.",en:"I will come in five minutes."},
{de:"Möchten Sie jetzt essen?",en:"Would you like to eat now?"},
{de:"Das Essen ist fertig.",en:"The food is ready."},
{de:"Schmeckt es Ihnen?",en:"Does it taste good to you?"},
{de:"Möchten Sie noch mehr?",en:"Would you like some more?"},
{de:"Sind Sie müde?",en:"Are you tired?"},
{de:"Möchten Sie schlafen?",en:"Would you like to sleep?"},
{de:"Ich mache das Licht aus.",en:"I will turn off the light."},
{de:"Ich mache das Licht an.",en:"I will turn on the light."},
{de:"Soll ich das Fenster öffnen?",en:"Shall I open the window?"},
{de:"Soll ich das Fenster schließen?",en:"Shall I close the window?"},
{de:"Tut das hier weh?",en:"Does it hurt here?"},
{de:"Zeigen Sie es mir bitte.",en:"Please show it to me."},
{de:"Geben Sie mir bitte Ihre Hand.",en:"Please give me your hand."},
{de:"Heben Sie bitte das Bein.",en:"Please lift your leg."},
{de:"Trinken Sie das bitte langsam.",en:"Please drink this slowly."},
{de:"Nehmen Sie bitte diese Tablette.",en:"Please take this tablet."},
{de:"Machen Sie bitte den Mund auf.",en:"Please open your mouth."},
{de:"Machen Sie bitte die Augen zu.",en:"Please close your eyes."},
{de:"Ich helfe Ihnen jetzt.",en:"I will help you now."},
{de:"Kommen Sie bitte her.",en:"Please come here."},
{de:"Wir gehen ganz langsam.",en:"We will go very slowly."},
{de:"Halten Sie sich bitte fest.",en:"Please hold on tight."},
{de:"Vorsicht, bitte!",en:"Careful, please!"},
{de:"Alles ist in Ordnung.",en:"Everything is okay."},
{de:"Keine Angst.",en:"Don't be afraid."},
{de:"Ich bin gleich fertig.",en:"I am almost done."},
{de:"Das dauert nicht lange.",en:"This won't take long."},
{de:"Möchten Sie zur Toilette?",en:"Would you like to go to the toilet?"},
{de:"Brauchen Sie Hilfe?",en:"Do you need help?"},
{de:"Hier ist die Klingel.",en:"Here is the call bell."},
{de:"Drücken Sie bitte hier.",en:"Please press here."},
{de:"Ich wasche Ihr Gesicht.",en:"I will wash your face."},
{de:"Ich kämme Ihre Haare.",en:"I will comb your hair."},
{de:"Möchten Sie sitzen oder liegen?",en:"Would you like to sit or lie down?"},
{de:"Ihre Familie ist da.",en:"Your family is here."},
{de:"Sie haben Besuch.",en:"You have a visitor."},
{de:"Möchten Sie fernsehen?",en:"Would you like to watch TV?"},
{de:"Ist das Bett bequem?",en:"Is the bed comfortable?"},
{de:"Ich hole Ihnen ein Glas Saft.",en:"I will get you a glass of juice."},
{de:"Sagen Sie mir, wenn es genug ist.",en:"Tell me when it is enough."},
...
{de:"Können Sie mir sagen, wo es wehtut?",en:"Can you tell me where it hurts?"},
{de:"Haben Sie heute schon etwas gegessen?",en:"Have you eaten anything today?"},
{de:"Ich möchte Ihre Temperatur noch einmal messen.",en:"I would like to measure your temperature again."},
{de:"Sie sollten heute viel trinken.",en:"You should drink a lot today."},
{de:"Dürfen Sie schon wieder aufstehen?",en:"Are you allowed to get up again already?"},
{de:"Ich muss kurz Ihren Verband kontrollieren.",en:"I need to check your bandage briefly."},
{de:"Möchten Sie, dass ich das Fenster öffne?",en:"Would you like me to open the window?"},
{de:"Konnten Sie letzte Nacht schlafen?",en:"Were you able to sleep last night?"},
{de:"Wann haben Sie zuletzt Ihre Tablette genommen?",en:"When did you last take your tablet?"},
{de:"Das Abendessen wird um sechs Uhr serviert.",en:"Dinner is served at six o'clock."},
{de:"Sie haben morgen eine Untersuchung.",en:"You have an examination tomorrow."},
{de:"Bitte ziehen Sie dieses Hemd an.",en:"Please put on this gown."},
{de:"Können Sie Ihren Arm heben?",en:"Can you raise your arm?"},
{de:"Ich zeige Ihnen, wie es funktioniert.",en:"I will show you how it works."},
{de:"Haben Sie Fragen zu Ihrer Behandlung?",en:"Do you have questions about your treatment?"},
{de:"Ihr Zimmer wird gerade sauber gemacht.",en:"Your room is being cleaned right now."},
{de:"Der Arzt möchte noch einige Tests machen.",en:"The doctor wants to do a few more tests."},
{de:"Sie müssen vor der Untersuchung nüchtern sein.",en:"You must be fasting before the examination."},
{de:"Ich schaue in einer Stunde wieder nach Ihnen.",en:"I will check on you again in an hour."},
{de:"Möchten Sie mit Ihrer Familie telefonieren?",en:"Would you like to phone your family?"},
{de:"Ich habe Ihre Medikamente auf den Tisch gelegt.",en:"I have put your medications on the table."},
{de:"Bitte melden Sie sich, wenn Ihnen schwindelig wird.",en:"Please tell me if you feel dizzy."},
{de:"Wir müssen Ihr Bett frisch beziehen.",en:"We need to change your bed linen."},
{de:"Haben Sie in letzter Zeit abgenommen?",en:"Have you lost weight recently?"},
{de:"Können Sie mir Ihre Beschwerden beschreiben?",en:"Can you describe your symptoms?"},
{de:"Nehmen Sie diese Tropfen dreimal am Tag.",en:"Take these drops three times a day."},
{de:"Ich helfe Ihnen beim Anziehen.",en:"I will help you get dressed."},
{de:"Sie dürfen heute duschen.",en:"You may shower today."},
{de:"Bitte bewegen Sie sich nicht zu schnell.",en:"Please don't move too quickly."},
{de:"Der Physiotherapeut wartet schon auf Sie.",en:"The physiotherapist is already waiting for you."},
{de:"Wie fühlt sich Ihr Bauch an?",en:"How does your stomach feel?"},
{de:"Ist der Schmerz stärker oder schwächer geworden?",en:"Has the pain become stronger or weaker?"},
{de:"Ich notiere das in Ihrer Akte.",en:"I will note that in your file."},
{de:"Möchten Sie noch ein Kissen?",en:"Would you like another pillow?"},
{de:"Sie bekommen heute eine neue Infusion.",en:"You will get a new IV drip today."},
{de:"Bitte sagen Sie mir, wenn die Nadel wehtut.",en:"Please tell me if the needle hurts."},
{de:"Wir kontrollieren Ihren Blutzucker vor dem Essen.",en:"We check your blood sugar before eating."},
{de:"Können Sie alleine zur Toilette gehen?",en:"Can you go to the toilet on your own?"},
{de:"Ich lasse die Tür offen.",en:"I will leave the door open."},
{de:"Ihre Werte sehen heute besser aus.",en:"Your values look better today."},
{de:"Sie haben ein bisschen Fieber.",en:"You have a slight fever."},
{de:"Ich lege Ihnen ein kühles Tuch auf die Stirn.",en:"I will put a cool cloth on your forehead."},
{de:"Möchten Sie jetzt Ihre Angehörigen sehen?",en:"Would you like to see your relatives now?"},
{de:"Bitte unterschreiben Sie dieses Formular.",en:"Please sign this form."},
{de:"Wir bringen Sie gleich in den OP.",en:"We will take you to the operating room shortly."},
{de:"Nach der Operation ruhen Sie sich gut aus.",en:"After the operation, rest well."},
{de:"Sie werden bald wieder zu Kräften kommen.",en:"You will soon regain your strength."},
{de:"Haben Sie heute genug getrunken?",en:"Have you drunk enough today?"},
{de:"Ich stelle Ihnen die Wasserflasche ans Bett.",en:"I will put the water bottle by your bed."},
{de:"Rufen Sie mich, sobald Sie etwas brauchen.",en:"Call me as soon as you need something."},
],
B1:[
...
{de:"Ich erkläre Ihnen jetzt, wie die Untersuchung abläuft.",en:"I will now explain how the examination proceeds."},
{de:"Falls Sie sich unwohl fühlen, drücken Sie sofort die Klingel.",en:"If you feel unwell, press the bell immediately."},
{de:"Bevor wir beginnen, möchte ich Ihnen einige Fragen stellen.",en:"Before we begin, I would like to ask you a few questions."},
{de:"Sobald die Ergebnisse da sind, informiere ich Sie.",en:"As soon as the results are in, I will inform you."},
{de:"Damit die Wunde gut heilt, müssen wir sie sauber halten.",en:"So that the wound heals well, we must keep it clean."},
{de:"Weil Ihr Blutdruck niedrig ist, sollten Sie langsam aufstehen.",en:"Because your blood pressure is low, you should get up slowly."},
{de:"Ich zeige Ihnen, wie Sie den Inhalator richtig benutzen.",en:"I will show you how to use the inhaler correctly."},
{de:"Es ist wichtig, dass Sie die Medikamente regelmäßig einnehmen.",en:"It is important that you take the medication regularly."},
{de:"Wenn die Schmerzen stärker werden, geben wir Ihnen etwas dagegen.",en:"If the pain gets worse, we will give you something for it."},
{de:"Nachdem Sie gegessen haben, machen wir einen kurzen Spaziergang.",en:"After you have eaten, we will take a short walk."},
{de:"Obwohl es anstrengend ist, ist Bewegung sehr wichtig für Sie.",en:"Although it is tiring, movement is very important for you."},
{de:"Ich möchte sichergehen, dass Sie alles verstanden haben.",en:"I want to make sure you have understood everything."},
{de:"Bitte informieren Sie uns, falls sich etwas verändert.",en:"Please inform us if anything changes."},
{de:"Wir überwachen Ihren Zustand, bis Sie stabil sind.",en:"We will monitor your condition until you are stable."},
{de:"Die Schwester hilft Ihnen, sobald sie Zeit hat.",en:"The nurse will help you as soon as she has time."},
{de:"Ich muss Ihnen leider mitteilen, dass sich der Termin verschiebt.",en:"Unfortunately I must tell you that the appointment is being postponed."},
{de:"Solange Sie die Infusion bekommen, sollten Sie im Bett bleiben.",en:"As long as you are getting the infusion, you should stay in bed."},
{de:"Ich erkläre Ihnen, worauf Sie zu Hause achten müssen.",en:"I will explain what you need to watch out for at home."},
{de:"Wir passen die Dosis an, wenn es nötig ist.",en:"We will adjust the dose if necessary."},
{de:"Falls Sie Nebenwirkungen bemerken, melden Sie sich bitte sofort.",en:"If you notice side effects, please report immediately."},
{de:"Ich kümmere mich darum, dass Sie einen Termin bekommen.",en:"I will make sure you get an appointment."},
{de:"Da Sie heute entlassen werden, besprechen wir die nächsten Schritte.",en:"Since you are being discharged today, we will discuss the next steps."},
{de:"Es kann sein, dass Sie sich nach der Narkose müde fühlen.",en:"It is possible that you will feel tired after the anaesthesia."},
{de:"Ich bleibe bei Ihnen, bis der Arzt kommt.",en:"I will stay with you until the doctor comes."},
{de:"Achten Sie darauf, dass die Wunde trocken bleibt.",en:"Make sure that the wound stays dry."},
{de:"Wir möchten wissen, ob Sie allergisch auf Medikamente reagieren.",en:"We want to know whether you react allergically to medications."},
{de:"Ich notiere mir, dass Sie eine salzarme Kost brauchen.",en:"I will note that you need a low-salt diet."},
{de:"Sobald Sie sich besser fühlen, dürfen Sie nach Hause.",en:"As soon as you feel better, you may go home."},
{de:"Es wäre gut, wenn Sie mehrmals am Tag tief durchatmen.",en:"It would be good if you breathe deeply several times a day."},
{de:"Ich erkläre Ihrer Tochter, wie sie Sie unterstützen kann.",en:"I will explain to your daughter how she can support you."},
{de:"Weil die Untersuchung nüchtern erfolgt, frühstücken Sie bitte nicht.",en:"Because the exam is done fasting, please do not have breakfast."},
{de:"Wir stellen sicher, dass Sie schmerzfrei sind.",en:"We make sure that you are free of pain."},
{de:"Wenn Sie möchten, kann ich das Gespräch mit dem Arzt organisieren.",en:"If you like, I can arrange the conversation with the doctor."},
{de:"Ich zeige Ihnen die Übungen, die Sie täglich machen sollten.",en:"I will show you the exercises you should do daily."},
{de:"Falls Sie stürzen, versuchen Sie nicht, alleine aufzustehen.",en:"If you fall, do not try to get up alone."},
{de:"Bitte trinken Sie regelmäßig, auch wenn Sie keinen Durst haben.",en:"Please drink regularly, even if you are not thirsty."},
{de:"Ich sorge dafür, dass Sie ein ruhiges Zimmer bekommen.",en:"I will arrange for you to get a quiet room."},
{de:"Da Sie Diabetiker sind, überwachen wir Ihren Zucker genau.",en:"Since you are diabetic, we monitor your sugar closely."},
{de:"Bevor Sie entlassen werden, prüfen wir noch einmal Ihre Werte.",en:"Before you are discharged, we will check your values once more."},
{de:"Ich möchte Ihnen erklären, warum diese Untersuchung nötig ist.",en:"I would like to explain why this examination is necessary."},
{de:"Sollten Sie Atemnot bekommen, benachrichtigen Sie uns umgehend.",en:"Should you become short of breath, notify us immediately."},
{de:"Wir dokumentieren, wie viel Sie trinken und ausscheiden.",en:"We document how much you drink and excrete."},
{de:"Ich gebe Ihnen einen Zettel mit, auf dem alles steht.",en:"I will give you a note on which everything is written."},
{de:"Wenn alles gut verläuft, können Sie übermorgen nach Hause.",en:"If all goes well, you can go home the day after tomorrow."},
{de:"Ich bespreche mit dem Arzt, ob wir die Therapie ändern.",en:"I will discuss with the doctor whether we change the therapy."},
{de:"Es ist normal, dass die Wunde am Anfang etwas spannt.",en:"It is normal for the wound to feel a bit tight at first."},
{de:"Bitte bewegen Sie die Zehen, damit das Blut gut zirkuliert.",en:"Please move your toes so that the blood circulates well."},
{de:"Ich erkläre Ihnen, wie Sie die Spritze selbst setzen können.",en:"I will explain how you can give yourself the injection."},
{de:"Wir warten mit dem Essen, bis die Betäubung nachlässt.",en:"We will wait with the food until the numbness wears off."},
{de:"Sagen Sie mir bitte Bescheid, wenn Sie zur Ruhe kommen möchten.",en:"Please let me know if you would like to rest."},
],
B2:[
...
{de:"Im Rahmen der Aufnahme benötigen wir einige Angaben zu Ihrer Krankengeschichte.",en:"As part of admission, we need some details about your medical history."},
{de:"Die weiterführende Diagnostik wird zeigen, ob ein Eingriff erforderlich ist.",en:"Further diagnostics will show whether a procedure is necessary."},
{de:"Wir möchten sicherstellen, dass die Schmerzmedikation optimal eingestellt ist.",en:"We want to ensure the pain medication is optimally adjusted."},
{de:"Sollten sich Komplikationen ergeben, leiten wir umgehend die entsprechenden Maßnahmen ein.",en:"Should complications arise, we will immediately initiate the appropriate measures."},
{de:"Die Ergebnisse der Blutuntersuchung liegen im Grenzbereich und bedürfen einer Kontrolle.",en:"The blood test results are borderline and require a follow-up."},
{de:"Ich möchte mit Ihnen die verschiedenen Behandlungsoptionen ausführlich besprechen.",en:"I would like to discuss the various treatment options with you in detail."},
{de:"Aus pflegerischer Sicht empfehle ich eine engmaschige Beobachtung über Nacht.",en:"From a nursing perspective, I recommend close observation overnight."},
{de:"Die Entlassung setzt voraus, dass die häusliche Versorgung gesichert ist.",en:"Discharge requires that home care is ensured."},
{de:"Wir arbeiten eng mit dem Sozialdienst zusammen, um Ihre Nachsorge zu organisieren.",en:"We work closely with social services to organize your aftercare."},
{de:"Bitte beachten Sie, dass bestimmte Medikamente die Wirkung anderer beeinflussen können.",en:"Please note that certain medications can affect the effect of others."},
{de:"Die interdisziplinäre Fallbesprechung findet morgen früh statt.",en:"The interdisciplinary case discussion takes place tomorrow morning."},
{de:"Angesichts Ihrer Vorerkrankungen gehen wir besonders vorsichtig vor.",en:"Given your pre-existing conditions, we proceed with particular caution."},
{de:"Wir dokumentieren sämtliche Vitalparameter lückenlos, um Veränderungen frühzeitig zu erkennen.",en:"We document all vital parameters completely to detect changes early."},
{de:"Die Aufklärung über Risiken und Nutzen ist gesetzlich vorgeschrieben.",en:"Informing you about risks and benefits is required by law."},
{de:"Sofern Sie einverstanden sind, ziehen wir einen Facharzt hinzu.",en:"If you agree, we will consult a specialist."},
{de:"Der Heilungsverlauf gestaltet sich bislang äußerst zufriedenstellend.",en:"The healing process has so far been extremely satisfactory."},
{de:"Wir behalten uns vor, die Therapie je nach Verlauf anzupassen.",en:"We reserve the right to adjust the therapy depending on progress."},
{de:"Eine ausgewogene Ernährung trägt maßgeblich zu Ihrer Genesung bei.",en:"A balanced diet contributes significantly to your recovery."},
{de:"Bitte teilen Sie uns mit, falls Sie eine Patientenverfügung hinterlegt haben.",en:"Please tell us if you have deposited an advance directive."},
{de:"Die postoperative Mobilisation beugt Komplikationen wie einer Thrombose vor.",en:"Postoperative mobilization prevents complications such as thrombosis."},
{de:"Wir legen großen Wert auf eine transparente Kommunikation mit Ihren Angehörigen.",en:"We place great value on transparent communication with your relatives."},
{de:"Die Befunde deuten darauf hin, dass eine ambulante Weiterbehandlung ausreicht.",en:"The findings suggest that outpatient follow-up treatment is sufficient."},
{de:"Ich bitte Sie, mögliche Unverträglichkeiten unbedingt anzugeben.",en:"I ask you to be sure to indicate any possible intolerances."},
{de:"Unser Ziel ist es, Ihre Selbstständigkeit weitestgehend zu erhalten.",en:"Our goal is to preserve your independence as much as possible."},
{de:"Die Medikamentendosis wird schrittweise reduziert, um Entzugserscheinungen zu vermeiden.",en:"The medication dose is reduced gradually to avoid withdrawal symptoms."},
{de:"Selbstverständlich unterliegt alles, was Sie mir sagen, der Schweigepflicht.",en:"Naturally, everything you tell me is subject to confidentiality."},
{de:"Die Rehabilitationsmaßnahmen sollten nahtlos an den Krankenhausaufenthalt anschließen.",en:"The rehabilitation measures should follow the hospital stay seamlessly."},
{de:"Wir überprüfen regelmäßig, ob die eingeleitete Therapie den gewünschten Erfolg zeigt.",en:"We regularly check whether the initiated therapy shows the desired success."},
{de:"Bei anhaltenden Beschwerden ist eine erneute Vorstellung unbedingt ratsam.",en:"With persistent symptoms, a re-presentation is strongly advisable."},
{de:"Die Pflegeplanung berücksichtigt Ihre individuellen Bedürfnisse und Wünsche.",en:"The care plan takes into account your individual needs and wishes."},
{de:"Ich möchte betonen, wie wichtig Ihre aktive Mitarbeit für den Genesungsprozess ist.",en:"I want to emphasize how important your active cooperation is for the recovery process."},
{de:"Wir stimmen den Entlassungszeitpunkt sorgfältig mit dem behandelnden Arzt ab.",en:"We carefully coordinate the discharge time with the attending doctor."},
{de:"Etwaige Fragen zur Abrechnung klärt gerne unsere Verwaltung mit Ihnen.",en:"Our administration will gladly clarify any billing questions with you."},
{de:"Die kontinuierliche Überwachung ermöglicht es uns, rechtzeitig zu reagieren.",en:"Continuous monitoring enables us to react in time."},
{de:"Es ist ratsam, körperliche Anstrengung in den ersten Wochen zu vermeiden.",en:"It is advisable to avoid physical exertion in the first weeks."},
{de:"Wir informieren Sie umfassend über den weiteren Ablauf Ihrer Behandlung.",en:"We will inform you comprehensively about the further course of your treatment."},
{de:"Die Verabreichung erfolgt streng nach ärztlicher Anordnung.",en:"Administration is carried out strictly according to the doctor's orders."},
{de:"Aufgrund des Infektionsrisikos gelten auf dieser Station besondere Hygienevorschriften.",en:"Due to the infection risk, special hygiene rules apply on this ward."},
{de:"Ich empfehle Ihnen dringend, das Rauchen dauerhaft einzustellen.",en:"I strongly recommend that you stop smoking permanently."},
{de:"Die Prognose hängt wesentlich davon ab, wie konsequent Sie die Therapie einhalten.",en:"The prognosis depends significantly on how consistently you follow the therapy."},
{de:"Wir behandeln Sie nach den aktuellen medizinischen Leitlinien.",en:"We treat you according to current medical guidelines."},
{de:"Bitte haben Sie Verständnis dafür, dass Untersuchungen manchmal Wartezeiten mit sich bringen.",en:"Please understand that examinations sometimes involve waiting times."},
{de:"Sollten Sie mit einer Maßnahme nicht einverstanden sein, respektieren wir Ihre Entscheidung.",en:"Should you disagree with a measure, we respect your decision."},
{de:"Die Wundheilung wird durch eine ausreichende Eiweißzufuhr unterstützt.",en:"Wound healing is supported by an adequate protein intake."},
{de:"Ich stelle Ihnen die zuständige Pflegekraft für die Nachtschicht vor.",en:"I will introduce the nurse responsible for the night shift."},
{de:"Wir bemühen uns, Ihren Aufenthalt so angenehm wie möglich zu gestalten.",en:"We strive to make your stay as pleasant as possible."},
{de:"Die Anpassung Ihrer Blutverdünnung erfordert regelmäßige Kontrollen.",en:"Adjusting your blood thinner requires regular checks."},
{de:"Bei Bedarf organisieren wir für Sie einen Dolmetscher.",en:"If needed, we will organize an interpreter for you."},
{de:"Ihre Beschwerden nehmen wir sehr ernst und gehen ihnen gründlich nach.",en:"We take your symptoms very seriously and investigate them thoroughly."},
{de:"Zögern Sie nicht, uns jederzeit auf Unklarheiten anzusprechen.",en:"Do not hesitate to raise any uncertainties with us at any time."},
],
}
